   <div class="row-fluid">
       <a href="class.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Class</a>
                        ...
                        <div class="block">
							...
							<?php
                    $class_query = "select * from class where class_id = '$get_id'";
                    $data = fetchData($con, $class_query);
...
$class_query = "update class set class_name = '$class_name' where class_id = '$get_id' ";
                    $data = fetchData($con, $class_query);
?>
