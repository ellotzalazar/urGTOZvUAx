                ...
                <div class="span9" id="content">
					...
					?>
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header"><h3>Click The Student To View a Profile</h3>
                                ...
                                <div class="span12">
									<ul	 id="da-thumbs" class="da-thumbs" >
										    		...
										    		<?php
														...
														$my_student = fetchData($con,"SELECT *
											...
											<li id="del<?php echo $id; ?>">
												<a  class="" href="my_classmate_profile.php <?php echo '?id='.$id; ?>">
												...
												<p class="subject"><?php echo $row['username']; ?></p>
											</li>
									<?php } ?>
									</ul>
                            </tbody>
