			<form id="login_form1" class="form-signin" method="post">
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Bacoor Parochial school of St. Michael the Archangel, Inc. Web Portal", { header: 'Access Granted' });
									var delay = 1000;
			...
			New to Bacoor Parochial school of St. Michael the Archangel, Inc.
			<hr>
