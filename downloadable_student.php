                ...
                <div class="span6" id="content">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 	$query = fetchData($con,"select * FROM files where class_id = '$get_id' order by fdatein DESC ");
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								<?php
									$query = fetchData($con,"select * FROM files where class_id = '$get_id' order by fdatein DESC ");
									$count = mysqli_num_rows($query);	
								if ($count == '0'){ ?>
