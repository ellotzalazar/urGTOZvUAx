   <div class="row-fluid">
    <a href="department.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Department</a>
                        ...
                        <div class="block">
							...
							<?php 
              $query = fetchData($con, "select * from department where department_id = '$get_id'");
 ...
 fetchData($con,"update department set department_name = '$dn' , dean  = '$d' where department_id = '$get_id' ");
 ?>
 <script>
