<?php include('header.php'); ?>
  <body id="login" background="images/backup/index.jpg">
	...
	<script>
		...
		if(html=='admin')
			{
				$.jGrowl("Welcome to Welcome to: Bacoor Parochial school of St. Michael the Archangel, Inc. Web Portal", 
					{ header: 'Access Granted' });
				var delay = 2000;
				setTimeout(function()
				{ window.location = 'dashboard.php'  }, delay);  
			}

		else if (html=='superadmin') 
			{
				$.jGrowl("Welcome to Welcome to: Bacoor Parochial school of St. Michael the Archangel, Inc. Web Portal", 
					{ header: 'Access Granted' });
				var delay = 2000;
