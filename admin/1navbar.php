  <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <span class="brand" href="#">Welcome to: Bacoor Parochial School of St. Michael the Archangel, Inc. Web Portal</span>
						...
						?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                    <li>
                                        <a tabindex="-1" href="1logout.php"><i class="icon-signout"></i>&nbsp;Logout</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
