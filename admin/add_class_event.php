...
if (isset($_POST['add'])){
	...
	$query = "insert into event (date_end,date_start,event_title) values('$date_end','$date_start','$title')";
...
?>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
									...
									<?php 
									$query = "select * from event where teacher_class_id = '' ";
									$data = fetchData($con, $query);

										while($event_row = mysqli_fetch_array($data)){
