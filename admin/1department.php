...
<?php include('1session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('1department_sidebar.php'); ?>
				<div class="span3" id="adduser">
				<?php include('1add_department.php'); ?>		   			
				</div>
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- block -->
									...
									<?php include('1modal_delete.php'); ?>
										...
										<tbody>
													...
													<tr>
														...
														<td width="30"><a href="1edit_department.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i></a></td>
