						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									<?php
									$query = "select * from subject where subject_id = '$get_id'";
									...
									?>
										...
										$query = "insert into activity_log (date,username,action) values(NOW(),'$user_username','Edit Subject $subject_code')";
										$data = fetchData($con,$query);
										?>
										<script>
