...
<html class="no-js">
    <head>
        <title>Welcome to: Bacoor Parochial school of St. Michael the Archangel, Inc. Web Portal</title>
		<meta name="description" content="Welcome to: Bacoor Parochial school of St. Michael the Archangel, Inc. Web Portal">
		<meta name="keywords" content="Bacoor">
		<meta name="author" content="MRS">
		<meta charset="UTF-8">
        <!-- Bootstrap -->
		<link href="admin/images/logo2.png" rel="icon" type="image">
