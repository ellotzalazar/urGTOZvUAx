...
$query = "update users set username = '$username'  , firstname = '$firstname' , lastname = '$lastname' where user_id = '$get_id' ";
$data = fetchData($con, $query);

$query = "insert into activity_log (date,username,action) values(NOW(),'$user_username','Edit User $username')";
$data = fetchData($con, $query);
